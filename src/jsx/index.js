...
import SvasthaaHome from "./components/Dashboard/SvasthaaHome";
...
const LearningCategory =lazy(() => import('./pages/learning/LearningCategory'));
const PlanCategory =lazy(() => import('./pages/plan/PlanCategory'));
const PlanDetails =lazy(() => import('./pages/plan/PlanDetails'));
const PlanQuestions =lazy(() => import('./pages/plan/PlanQuestions'));
const PlanOrders =lazy(() => import('./pages/plan/PlanOrders'));
const LearningContent =lazy(() => import('./pages/learning/LearningContent'));
const QuizTopics =lazy(() => import('./pages/quiz/QuizTopics'));
const QuizQuestions =lazy(() => import('./pages/quiz/QuizQuestion'));
const Markup = () => {
  ...
  const routes = [
    ...
    { url: "svsdashboard", component: SvasthaaHome },
    ...
    {url:"plancategory",component:PlanCategory},
    {url:"plandetails",component:PlanDetails},
    {url:"planquestions",component:PlanQuestions},
    {url:"planorders",component:PlanOrders},
    {url:"learnings",component:LearningCategory},
    {url:"learningcontent",component:LearningContent},
    {url:"quiztopics",component:QuizTopics},
    {url:"quizquestions",component:QuizQuestions},
  ];
