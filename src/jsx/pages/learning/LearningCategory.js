...
const AddLearningCategory = lazy(() => import('./AddLearningCategory'));
const LearningSubCategory = lazy(() => import('./LearningSubCategory'));
    ...
    return (
        <>
            <Col lg={12}>
                <Card>
                    <Card.Header>
                        <Card.Title>Learning Category <Button onClick={() => openModal(1, '')}
                            className="me-2" variant="primary btn-square"
                            title="Add Learning Category"
                        >
...

                                {
                                    modaltype === 1 ? (
                                        <Suspense fallback={<div>Loading</div>}>
                                            <AddLearningCategory /> </Suspense>
                                    ) : modaltype === 2 ? (
                                        <Suspense fallback={<div>Loading</div>}>
                                            <LearningSubCategory /> </Suspense>
                                    ) 
                                        : null
