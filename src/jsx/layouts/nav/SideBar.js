          ...
          <Dropdown.Toggle variant="" as="a" className="nav-link i-false c-pointer">
            <div className="header-info2 d-flex align-items-center border">
              ...
              <div className="d-flex align-items-center sidebar-info">
                <div>
                  <span className="font-w700 d-block mb-2">Teju</span>
        ...
        <MM className="metismenu" id="menu">
          <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul >
              ...
              <li><Link className={`${path === "svsdashboard" ? "mm-active" : ""}`} to="/svsdashboard">Svasthaa Home</Link></li>
            </ul>
          </li>
          ...
          <li className={`${app.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul >
              <li><Link className={`${path === "plancategory" ? "mm-active" : ""}`}
                to="/plancategory">Plan Category</Link></li>
              <li><Link className={`${path === "plandetails" ? "mm-active" : ""}`}
                to="/plandetails">Plan Details</Link></li>

              <li><Link className={`${path === "planquestions" ? "mm-active" : ""}`}
                to="/planquestions">Plan Questions</Link></li>

              <li><Link className={`${path === "planorders" ? "mm-active" : ""}`}
                to="/planorders">Plan Orders</Link></li>
          ...
          <li className={`${app.includes(path) ? "mm-active" : ""}`}>
            <Link className="has-arrow" to="#" >
              <i className="fas fa-home"></i>
              <span className="nav-text">Learnings</span>
            </Link>
            <ul >
              <li><Link className={`${path === "learnings" ? "mm-active" : ""}`}
                to="/learnings">Learning Category</Link></li>
              <li><Link className={`${path === "learningcontent" ? "mm-active" : ""}`}
                to="/learningcontent">Learning Content</Link></li>
          ...
          <li className={`${app.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul >
              <li><Link className={`${path === "quiztopics" ? "mm-active" : ""}`}
                to="/quiztopics">Topics</Link></li>
              <li><Link className={`${path === "quizquestions" ? "mm-active" : ""}`}
                to="/quizquestions">Question & Answers</Link></li>

            </ul>
          </li>
          <li className={`${app.includes(path) ? "mm-active" : ""}`}>
              <Link to="searchpeople" className="ai-icon" >
